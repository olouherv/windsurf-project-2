    ...
    <div class="w-full">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100">
                <h3 class="text-lg font-semibold text-gray-900">Modifier l'année de formation</h3>
                <p class="text-sm text-gray-500">Programme: {{ $program->name }}</p>
            </div>
            <livewire:programs.program-year-form :programId="$program->id" :yearId="$year->id" />
        </div>
    </div>
</x-layouts.admin>
